<section class="flex">
    <div class="
        ...
        <div id="menu" class="h-full hidden sm:flex flex-col justify-around">
        ...
        <div class="relative flex items-center justify-between h-10">
            <div class="absolute inset-y-0 left-0 flex items-center bg-gray-800 rounded-md">
                ...
                <button id="toggle-menu" type="button" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 dark:text-white hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
                    ...
                    <svg class="icon-menu block h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
        ...
        <div class="grid grid-cols-4 col-auto gap-2 mb-4">
            <div class="p-4 shadow-lg bg-gray-800 rounded-md grid items-center">
                <div class="flex flex-col justify-around items-center w-full p-2 rounded-lg">
                    <h2 class="text-5xl font-medium text-gray-50">50</h2>
