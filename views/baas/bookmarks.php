<div class="w-3/4 p-6">
    <div class="w-full flex justify-start items-center">
        <button id="btn-add-bookmarks" class="w-1/3 text-white p-4 px-6 bg-sky-900 hover:bg-sky-700 focus:bg-sky-600 rounded-lg">
            Add Bookmarks
        </button>
    </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                        <?php
                        $i = 1;
                        // foreach ($bookmarkModal->getAllBookmarks() as $key => $value) {
                        //     echo "
                        ...
                        //                     <td class='p-2'>
                        //                         <a href='" . $data["baseUrl"] . "/api/edit/bookmark/" . $value["id"] . "' class='text-white p-2 px-6 bg-sky-900 hover:bg-sky-700 focus:bg-sky-600 rounded-lg'>Edit</a>
                        //                         <a href='" . $data["baseUrl"] . "/api/delete/bookmark/" . $value["id"] . "' class=' text-white p-2 px-6 bg-red-900 hover:bg-red-700 focus:bg-red-600 rounded-lg'>Delete</a>
                        //                     </td>
                        //                 </tr>";
                        //     $i++;
                        // }
...
<div id='bookmarks_modal' class='hidden fixed inset-0 z-50 bg-gray-600 bg-opacity-75 flex items-center justify-center p-3'>
    <div class='bg-gray-200 max-w-lg rounded-lg overflow-hidden px-3 lg:px-6 py-4 space-y-4'>
                ...
                <div class="relative rounded-md shadow-sm bg-gray-400">
                    <div class="xl:w-96">
                        <select class="
                                                ...
                                                focus:bg-white 
                                                focus:border-blue-600 
                                                focus:outline-none" name="user_id" aria-label="Select Bookmark" required>
                            <?php
                            // foreach ($users->Bookmarks() as $key => $value) {
        ...
        <div class='flex justify-end pt-4 text-gray-700'>
            <button id='btn_close_bookmarks_modal' type='button' class='rounded-lg px-5 py-2 border-2 border-gray-300 focus:border-transparent focus:outline-none hover:bg-gray-600 hover:text-gray-200 focus:bg-gray-700 focus:text-white focus:shadow-outline bg-white font-medium'>
                Tutup
            </button>
        </div>
    </div>
