<section class="text-gray-600 dark:text-gray-400 body-font overflow-hidden bg-gray-200 dark:bg-gray-700">
    <div class="container px-5 py-12 mx-auto min-h-screen">
        <div class="divide-y-2 divide-gray-300 ">
            ...
            <div class="pt-4 flex flex-warp gap-2">

                <?php
                foreach ($data["tagsAll"] as $key => $value) {
                ?>
                    <a href="<?= $data["baseUrl"] ?>/blogs/search/<?= $value["name"] ?>" class="flex justify-center items-center p-6 rounded-lg shadow-lg bg-white hover:bg-emerald-100 hover:drop-shadow-lg dark:bg-gray-600 dark:hover:bg-gray-700 dark:hover:drop-shadow-lg max-w-sm">
