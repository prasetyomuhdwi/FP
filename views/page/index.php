<section class="bg-gray-50 dark:text-gray-400 dark:bg-gray-900 body-font">
        ...
        <div class="h-3/4">
            <div class="max-w-full mx-auto px-4 pt-4 lg:pt-0 h-full flex justify-center items-center">
                <div class="dark:text-white">
                    ...
                    <span class="w-full inline-flex justify-center items-center mt-2 dark:text-gray-300">
                        tag,tag,tag
                    </span>
                </div>
            </div>
    ...
    <div class="sticky bottom-5 ml-7 pb-5">
        <a href="./blogs/create" type="button" class="flex items-center justify-center rounded-full bg-emerald-600 text-white leading-normal uppercase shadow-lg hover:bg-emerald-700 hover:shadow-lg focus:bg-emerald-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-emerald-800 active:shadow-lg transition duration-150 ease-in-out w-44 h-20">
            <div>
