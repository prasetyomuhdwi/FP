    ...
    <main class="bg-gray-200 dark:bg-gray-700 h-full py-8">
        <div class="max-w-6xl mx-auto px-4 pt-4 lg:pt-6">
            <div class="flex flex-warp gap-3">
                ...
                <form class="w-96 h-96 bg-gray-600 rounded-lg shadow-lg shrink-0 p-5" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col p-5 justify-center items-center">
                        ...
                        <div class='form-group mb-2'>
                            <div class='flex justify-center'>
                                <div class="py-3">
                                    <input class='form-contro block px-3 py-1.5 text-base font-normal
                                    text-gray-50 bg-gray-600 bg-clip-padding
                                    border border-solid rounded shadow-lg
                ...
                <div class="grow">
                    <form class="bg-gray-600 rounded-lg shadow-lg flex flex-col justify-around p-5">
                        ...
                        <div class="flex flex-col py-2">
                            ...
                            <input required type="text" id="username" name="username" value="<?= $data["user"]["username"] ?>" placeholder="username" class="border-b-2 p-2 dark:text-white rounded border-gray-400 focus:border-green-400 
                        ...
                        <div class="flex flex-col py-2">
                            ...
                            <input required type="text" id="fullname" name="fullname" value="<?= $data["user"]["fullname"] ?>" placeholder="fullname" class="border-b-2 p-2 dark:text-white rounded border-gray-400 focus:border-green-400 
                            text-gray-600 placeholder:pl-3 placeholder-gray-400 outline-none bg-gray-700">
                        </div>
                        <div class="flex flex-col py-2">
                            <label for="email" class="text-sm text-left 
                                 font-bold text-gray-300">Email : </label>
                            <input required type="email" id="email" name="email" value="<?= $data["user"]["email"] ?>" placeholder="email" class="border-b-2 p-2 dark:text-white rounded border-gray-400 focus:border-green-400 
                            text-gray-600 placeholder:pl-3 placeholder-gray-400 outline-none bg-gray-700">
                        </div>
                        <div class="flex flex-col py-2">
                            <label for="bio" class="text-sm text-left 
                                 font-bold text-gray-300">Bio : </label>
                            <textarea name="bio" id="bio" cols="30" rows="3" class="text-left border-b-2 p-2 dark:text-white rounded border-gray-400 focus:border-green-400 
                                text-gray-600 placeholder:pl-3 placeholder-gray-400 outline-none bg-gray-700"><?= trim($data["user"]["bio"]) ?></textarea>
                        </div>
                        <div class="flex flex-col py-2">
                    ...
                    <form class="bg-gray-600 rounded-lg shadow-lg flex flex-col justify-around p-5 mt-4">
                        ...
                        <div class="flex flex-col py-2">
                            ...
                            <input required type="password" id="password" name="password" placeholder="kata sandi" class="py-2 border-b-2 rounded border-gray-400 focus:border-green-400 
                            text-gray-600 placeholder:pl-3 placeholder-gray-400 outline-none bg-gray-700">
                        </div>
                        <div class="flex flex-col py-2">
                            <label for="re-password" class="text-sm text-left 
                                 font-bold text-gray-300">Konfirmasi Kata Sandi : </label>
                            <input required type="password" id="re-password" placeholder="konfirmasi kata sandi" class="py-2 border-b-2 rounded border-gray-400 focus:border-green-400 
                            text-gray-600 placeholder:pl-3 placeholder-gray-400 outline-none bg-gray-700">
                        </div>
                        <div class="flex flex-col py-2">
