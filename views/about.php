                ...
                <div class="flex justify-between dark:text-white">
                    ...
                    <div class="flex justify-center items-center">
                        <div class="flex items-center py-4 overflow-y-auto whitespace-nowrap">
                            <a href="./" class="<?php (($key == (count($currentUrl) - 1)) ? "text-blue-500 dark:text-blue-200" : "text-gray-600 dark:text-gray-200") ?>">
                            ...
                            if ($currentUrl[0] != "") {
                                foreach ($currentUrl as $key => $value) {
                                    ...
                                    echo "<a href='" . $value . "' class='" . (($key == (count($currentUrl) - 1)) ? "text-blue-500 dark:text-blue-300" : "text-gray-600 dark:text-gray-200") . " hover:underline'> " . ucfirst($value) . " </a>";
                                }
                            }
                            ?>
